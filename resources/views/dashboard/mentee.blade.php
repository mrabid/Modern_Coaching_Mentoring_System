                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 dark:text-gray-400 mt-2">
                            Here, you can explore available mentors, schedule sessions, and track your learning journey.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <form class="mt-6 space-y-4" id="mentor-filter-form">
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <div class="flex-grow">
                        ...
                        <select id="expertise" name="expertise" class="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                    ...
                    <!-- Search Button -->
                    <div class="self-end">
                        <button type="button" id="filter-button" class="w-full sm:w-auto bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-2 px-6 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500">
                            Search
                        </button>
                    </div>
                </div>
